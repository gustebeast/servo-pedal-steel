...
LEG_STATIONS_X = (-18.0, -602.0)       # narrow dovetail edge (station-14) lands on each
                                       # crossbar's inner face -> a clean XBAR gap to the
                                       # endplate: +X leg narrow edge -4 (10 mm to the
                                       # bridge face at +6); -X leg narrow edge -616 (= the
                                       # -X crossbar's +X face, XBAR off the keyhead back).
